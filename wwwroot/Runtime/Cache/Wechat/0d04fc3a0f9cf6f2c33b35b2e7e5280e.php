...
<div class="main">
    ...
    <div class="container-fluid" style="margin-top: 5%;">
        <form action="wechat?s=wechat/repaire/add" method="post">
            ...
            <div class="controls" style="margin-bottom: 20px;">
                <img class="verifyimg reloadverify" alt="点击切换" src="<?php echo U('user/verify');?>" style="cursor:pointer;">
            </div>
            <div class="form-group">
                <!--<button class="btn btn-primary onlineBtn">确认提交</button>-->
                <button type="submit" class="btn btn-primary onlineBtn">提交</button>
            </div>
        </form>
    </div>
