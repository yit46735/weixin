        ...
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src="<?php echo (get_cover($v["path"],'path')); ?>" alt="/Public/Wechat.">
                                <div class="caption">
                                    <h4><?php echo ($v["title"]); ?></h4>
                                    <p class="zushouInfo"><?php echo ($v["description"]); ?></p>
                                    <p class="text-danger"><?php echo ($v["price"]); echo ($v['unit']==1)?'元/月':'万/月';?></p>
                                    <p><a href="<?php echo U('Sale/detail?id='.$v['id']);?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                </div>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                    <div class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                        ...
                        <div class="row">
                            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-md-4">
                                        <div class="thumbnail">
                                            <img src="<?php echo (get_cover($v["path"],'path')); ?>" alt="/Public/Wechat.">
                                            <div class="caption">
                                                <h4><?php echo ($v["title"]); ?></h4>
