...
<body>
    ...
    <form action="<?php echo U('Sale/edit');?>" method="post" class="form-horizontal">
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                ...
                <select style="width: 200px;" name="unit">
                    ...
                    <option value="2" <?php echo ($info['unit']==2)?'selected':'';?>>万元/月</option>
                </select>
        ...
        <div class="controls">
            ...
            <input type="hidden" name="path" id="img" value="<?php echo ((isset($info["path"]) && ($info["path"] !== ""))?($info["path"]):''); ?>"/>
            <div class="upload-img-box">
                <?php if(!empty($info["path"])): ?><div class="upload-pre-item"><img src="<?php echo (get_cover($info["path"],'path')); ?>"/></div><?php endif; ?>
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <textarea name="content" cols="80" rows="20"><?php echo ((isset($info["content"]) && ($info["content"] !== ""))?($info["content"]):''); ?></textarea>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <textarea name="description" cols="80" rows="10"><?php echo ((isset($info["description"]) && ($info["description"] !== ""))?($info["description"]):''); ?></textarea>
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text time" name="deadline" value="<?php echo (time_format($info["deadline"])); ?>"></div>
        </div>
